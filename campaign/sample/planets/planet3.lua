...
--					{ 	name = 'euf_sarge', x = 230, z = 1800, facing = 1, },				
					{	name = "euf_transport_mis",	x = 250, z = 1850, facing = 1,  },
				},
				midgameUnits = {
					{ name = 'euf_transport_mis', x = 450, z = 1900, facing = 1, spawnRadius = 0, delay = 6*30, orbitalDrop = false,  },
				},
			},
			modoptions = { },
			...
			aiConfig = {
				...
				},
				{
					...
					startUnits = {
						...
						{ name = 'euf_solar', x = 4430, z = 608, facing = 0, },
						{ name = 'euf_solar', x = 4430, z = 704, facing = 0, },
						{ name = 'euf_solar', x = 4530, z = 608, facing = 0, },
						{ name = 'euf_solar', x = 4530, z = 704, facing = 0, },
						{ name = 'euf_solar', x = 4630, z = 608, facing = 0, },
						{ name = 'euf_solar', x = 4630, z = 704, facing = 0, },						
					...
					midgameUnits = {
						{ name = 'euf_marine_laser', x = 3840, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser', x = 3840, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser', x = 3840, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser', x = 3840, z = 1000, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						
						{ name = 'euf_marine_laser',  x = 3840, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_pyro',    x = 3840, z = 1000, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },

						{ name = 'euf_marine_laser',  x = 3840, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_sniper',  x = 3840, z = 1000, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },

						{ name = 'euf_marine_laser',  x = 3840, z = 880, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 890, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },	
						{ name = 'euf_marine_laser',  x = 3840, z = 880, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 890, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },						
						{ name = 'euf_marine_laser',  x = 3840, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_raider',  x = 3840, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_pyro',    x = 3840, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_sniper',  x = 3840, z = 1000, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },

						{ name = 'euf_marine_laser',  x = 3840, z = 880, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 890, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },	
						{ name = 'euf_marine_laser',  x = 3840, z = 880, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine_laser',  x = 3840, z = 890, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },						
						{ name = 'euf_tank',  x = 3840, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_raider',  x = 3840, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_pyro',    x = 3840, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_sniper',  x = 3840, z = 1000, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka_missile', x = 3840, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },						
					},
				},
			},
