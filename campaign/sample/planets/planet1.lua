...
--			feedbackLink = "http://zero-k.info/Forum/Thread/24417",
		...
		gameConfig = {
			...
			initialWrecks = {
				...
				{ name = 'buildingfeature_3', x = 3328, z = 37, facing = 0, },
				...
				{ name = 'buildingmodule_lvl0_7', x = 3365, z = 62, facing = 0, },
				{ name = 'buildingmodule_lvl1_2', x = 2222, z = 1931, facing = 0, },
				{ name = 'buildingmodule_lvl1_8', x = 3365, z = 62, facing = 0, },
			...
			aiConfig = {
				{
					...
					midgameUnits = {
						{	name = "euf_transport_mis",	x = 2920, z = 180, facing = 2, spawnRadius = 0, delay = 90*30, orbitalDrop = false, },						
					},					
				},
				{
					startX = 4000,
