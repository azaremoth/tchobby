...
--			feedbackLink = "http://zero-k.info/Forum/Thread/24417",
			text = [[Allied troops urgently need back-up on this planet. We lost many drop ships due to the undead air superiority. You need to find our lost troops, establish a base and support our troops!]]		},
		tips = {
			{	},
		},
		gameConfig = {
			...
			playerConfig = {
				...
				startUnits = {
						...
						{ name = 'euf_scorpion', x = 3758, z = 5500, facing = 2, commands = {{cmdID = planetUtilities.COMMAND.RAW_MOVE, pos = {3778, 5520}, options = {"shift"}}, }, },
						{ name = 'euf_scorpion', x = 3711, z = 5424, facing = 2, commands = {{cmdID = planetUtilities.COMMAND.RAW_MOVE, pos = {3731, 5444}, options = {"shift"}}, }, },
						{ name = 'euf_scorpion', x = 3619, z = 5407, facing = 2, commands = {{cmdID = planetUtilities.COMMAND.RAW_MOVE, pos = {3639, 5427}, options = {"shift"}}, }, },				
				},
				midgameUnits = {
			...
			aiConfig = {
				{
					...
					startUnits = {	
						...
						{ name = 'euf_interceptor', x = 3150, z = 100, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {3150, 6000}}, }, },
						{ name = 'euf_interceptor', x = 3150, z = 100, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {3150, 6000}}, }, },
						{ name = 'euf_interceptor', x = 3150, z = 100, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {3150, 6000}}, }, },

						{ name = 'euf_interceptor', x = 3150, z = 6000, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {3150, 100}}, }, },
						{ name = 'euf_interceptor', x = 3150, z = 6000, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {3150, 100}}, }, },
						{ name = 'euf_interceptor', x = 3150, z = 6000, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {3150, 100}}, }, },
					
						{ name = 'converter', x = 4880, z = 3700, facing = 0, },
						...
						{ name = 'converter', x = 940, z = 5150, facing = 3, },
						...
						{ name = 'euf_pyro', x = 846, z = 5023, facing = 3, },
						{ name = 'euf_pyro', x = 935, z = 5270, facing = 1, },

						{ name = 'converter', x = 4100, z = 430, facing = 1, },
				...
				},
				{
					...
					startUnits = {
						...
						{ name = 'tc_heart_ai', x = 9801, z = 2207, facing = 0, },
						...
						{ name = 'tc_blade', x = 6600, z = 5500, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {2300, 5250}}, }, },
						{ name = 'tc_blade', x = 6600, z = 5500, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {2300, 5250}}, }, },
						{ name = 'tc_blade', x = 6600, z = 5500, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {2300, 5250}}, }, },
						{ name = 'tc_blade', x = 6600, z = 5500, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {2300, 5250}}, }, },
						{ name = 'tc_blade', x = 6600, z = 5500, facing = 1, commands = {{cmdID = planetUtilities.COMMAND.PATROL, pos = {2300, 5250}}, }, },
