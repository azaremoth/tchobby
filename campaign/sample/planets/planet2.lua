...
--			feedbackLink = "http://zero-k.info/Forum/Thread/24417",
			text = [[The separatists do have a heavily fortified base on this planet. It will be hard to crack the defense lines with ground forces. However, these idiots forgot to establish anti-air. Thus, we should surprise them with bombers.]]		},
		tips = {
			{
		...
		gameConfig = {
			...
			initialWrecks = {
				{ name = 'euf_wall_lvl1_1', x = 1685, z = 1731, facing = -0.32, },
				{ name = 'euf_wall_lvl1_1', x = 1742, z = 1681, facing = 0.04, },
				{ name = 'euf_wall_lvl1_1', x = 2615, z = 600, facing = -2.31, },
				{ name = 'euf_wall_lvl1_2', x = 1614, z = 1758, facing = 0.22, },
				{ name = 'euf_wall_lvl1_2', x = 1642, z = 1755, facing = 0.43, },
				{ name = 'euf_wall_lvl1_2', x = 1704, z = 1716, facing = 0.73, },
				{ name = 'euf_wall_lvl1_2', x = 1739, z = 1669, facing = -1.68, },
				{ name = 'euf_wall_lvl1_2', x = 2583, z = 715, facing = 0.53, },
				{ name = 'euf_wall_lvl1_2', x = 2603, z = 698, facing = -1.72, },
				{ name = 'euf_wall_lvl1_2', x = 2621, z = 651, facing = 1.43, },
				{ name = 'euf_wall_lvl1_3', x = 1665, z = 1743, facing = -0.98, },
				{ name = 'euf_wall_lvl1_3', x = 1719, z = 1698, facing = -4.23, },
				{ name = 'euf_wall_lvl1_3', x = 2610, z = 677, facing = 0.05, },
				{ name = 'euf_wall_lvl1_3', x = 2611, z = 575, facing = -2.48, },
				{ name = 'euf_wall_lvl1_3', x = 2619, z = 625, facing = 0.23, },
				{ name = 'euf_walls_lvl2_mis', x = 1346, z = 1129, facing = 0.8, },
				{ name = 'euf_walls_lvl2_mis', x = 1402, z = 1072, facing = 0.8, },
				{ name = 'euf_walls_lvl2_mis', x = 1456, z = 1017, facing = 0.8, },
				{ name = 'euf_walls_lvl2_mis', x = 1489, z = 721, facing = 0, },
				{ name = 'euf_walls_lvl2_mis', x = 1512, z = 961, facing = 0.8, },
				{ name = 'euf_walls_lvl2_mis', x = 1563, z = 901, facing = 0.91, },
				{ name = 'euf_walls_lvl2_mis', x = 1569, z = 721, facing = 0, },
				{ name = 'euf_walls_lvl2_mis', x = 1596, z = 833, facing = 1.34, },
				{ name = 'euf_walls_lvl2_mis', x = 1608, z = 756, facing = -1.65, },
				{ name = 'euf_walls_lvl2_mis', x = 1887, z = 773, facing = 0, },
				{ name = 'euf_walls_lvl2_mis', x = 1964, z = 762, facing = -2.84, },
				{ name = 'euf_walls_lvl2_mis', x = 2024, z = 721, facing = -2.24, },
				{ name = 'euf_walls_lvl2_mis', x = 2053, z = 652, facing = 1.46, },
				{ name = 'euf_walls_lvl2_mis', x = 2521, z = 167, facing = 0.64, },
				{ name = 'euf_walls_lvl2_mis', x = 2591, z = 131, facing = 0.31, },
				{ name = 'euf_walls_lvl2_mis', x = 2665, z = 106, facing = 0.31, },
				{ name = 'euf_walls_lvl2_mis', x = 2738, z = 80, facing = 0.4, },
				{ name = 'euf_walls_lvl2_mis', x = 2797, z = 35, facing = 0.89, },			
				{ name = 'agrarhut', x = 1493, z = 889, facing = 2.24, },
				{ name = 'agrarhut', x = 150, z = 2679, facing = -0.21, },
				{ name = 'barrel', x = 1468, z = 734, facing = 0.01, },
				{ name = 'barrel', x = 456, z = 100, facing = -0.01, },
				{ name = 'barrels', x = 1510, z = 741, facing = -0.62, },
				{ name = 'barrels', x = 228, z = 2676, facing = 1.02, },
				{ name = 'bighouse', x = 2032, z = 74, facing = 0, },
				{ name = 'bld_tunnel_low', x = 1919, z = 75, facing = 1, },
				{ name = 'box', x = 1544, z = 740, facing = 0, },
				{ name = 'box', x = 209, z = 2719, facing = 0, },
				{ name = 'box', x = 231, z = 2709, facing = 0.36, },
				{ name = 'box', x = 2532, z = 174, facing = 0.97, },
				{ name = 'boxes', x = 1580, z = 795, facing = -0.69, },
				{ name = 'boxes', x = 2480, z = 140, facing = 0, },
				{ name = 'boxes', x = 412, z = 78, facing = 4.51, },
				{ name = 'boxes', x = 441, z = 70, facing = 1.29, },
				{ name = 'boxes', x = 82, z = 2716, facing = 0.82, },
				{ name = 'buildingmodule_b2l_2', x = 1790, z = 77, facing = 0, },
				{ name = 'buildingmodule_lvl2_8', x = 1790, z = 79, facing = 0, },
				...
				{ name = 'containertype1', x = 481, z = 52, facing = 0.01, },
				{ name = 'containertype1', x = 783, z = 976, facing = -0.01, },
				{ name = 'containertype2', x = 536, z = 1088, facing = 0.87, },
				{ name = 'containertype2', x = 691, z = 59, facing = 0.02, },
				{ name = 'containertype2', x = 739, z = 976, facing = 0.01, },
				{ name = 'containertype3', x = 844, z = 981, facing = 0.39, },
				{ name = 'containertype4', x = 395, z = 30, facing = 1.61, },
				...
				{ name = 'tank', x = 1580, z = 747, facing = 0, },
			},				
			aiConfig = {
				{
					startX = 4000,
					...
					startUnits = {
						...
						{ name = 'euf_bazooka', x = 1331, z = 1907, facing = 0, },
						{ name = 'euf_bazooka', x = 1541, z = 1586, facing = 0, },
						{ name = 'euf_bazooka', x = 2027, z = 1490, facing = 0, },
						{ name = 'euf_bazooka', x = 2418, z = 1143, facing = 0, },
						{ name = 'euf_bazooka', x = 2475, z = 674, facing = 0, },
						{ name = 'euf_bazooka', x = 2586, z = 403, facing = 0, },
						{ name = 'euf_bazooka', x = 729, z = 2689, facing = 0, },
						{ name = 'euf_bazooka', x = 856, z = 359, facing = 0, },
						{ name = 'euf_bazooka', x = 892, z = 357, facing = 0, },
						...
						{ name = 'euf_factory_ai', x = 560, z = 512, facing = 3, },
						...
						{ name = 'euf_marine', x = 1824, z = 186, facing = 0, },
						{ name = 'euf_marine', x = 2678, z = 337, facing = 1, },
						{ name = 'euf_marine', x = 2692, z = 273, facing = 1, },
						{ name = 'euf_marine', x = 849, z = 707, facing = 0, },
						{ name = 'euf_marine', x = 849, z = 750, facing = 0, },
						{ name = 'euf_marine', x = 902, z = 752, facing = 0, },
						...
						{ name = 'euf_sniper_ai', x = 1376, z = 1824, facing = 1, },
						{ name = 'euf_sniper_ai', x = 1844, z = 1457, facing = 1, },
						{ name = 'euf_sniper_ai', x = 2086, z = 2664, facing = 1, },
						{ name = 'euf_sniper_ai', x = 2370, z = 110, facing = 1, },
						{ name = 'euf_sniper_ai', x = 2454, z = 872, facing = 1, },
						...
						{ name = 'euf_tank', x = 1559, z = 670, facing = 2, },
					},
					midgameUnits = {
